...
namespace YourProject.Tests
{
    ...
    {
        private Mock<ILogger<DriversService>> loggerMock;
        ...
        {
            loggerMock = new Mock<ILogger<DriversService>>();
            driversRepositoryMock = new Mock<IDriversRepository>();
            driversService = new DriversService(driversRepositoryMock.Object, loggerMock.Object);
        }
